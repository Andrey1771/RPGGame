...
AnimatedTield::AnimatedTield(const UtilitiesGame::TextureData movementTexture, const UtilitiesGame::SizeXY& valueSizeXY, int currentFrameY/*Не хочу просить Пашка переделывать, тк он неправильно структуризировал стенки*/, double speedAnimation)
{
